...
tellraw @a [{"text":"<DrinkingCraft> ","color":"gold","bold":true},{"selector":"@s","color":"blue","bold":false},{"text":" was brave enough to slay the Warden, everyone must take a drink, except ","color":"blue","bold":false},{"selector":"@s","color":"blue","bold":false},{"text":"!","color":"blue","bold":false}]
