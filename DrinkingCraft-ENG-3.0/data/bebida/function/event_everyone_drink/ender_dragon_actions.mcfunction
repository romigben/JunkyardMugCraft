...
tellraw @a [{"text":"<DrinkingCraft> ","color":"gold","bold":true},{"selector":"@s","color":"dark_purple","bold":false},{"text":" killed the Ender Dragon, time for everyone to take a celebratory drink!","color":"dark_purple","bold":false}]
