...
tellraw @a [{"text":"<Mugcraft> ","color":"gold","bold":true},{"selector":"@s","color":"dark_aqua","bold":false},{"text":" has already gotten a crafting table. What are you, a speedrunner? Take a drink to relax.","color":"dark_aqua","bold":false}]
