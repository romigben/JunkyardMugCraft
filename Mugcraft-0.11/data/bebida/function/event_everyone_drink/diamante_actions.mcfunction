...
tellraw @a [{"text":"<Mugcraft> ","color":"gold","bold":true},{"selector":"@s","color":"aqua","bold":false},{"text":" has mined an outstanding diamond, everyone must take a sip of their drinks!","color":"aqua","bold":false}]
