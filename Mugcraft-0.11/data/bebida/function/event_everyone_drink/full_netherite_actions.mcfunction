...
tellraw @a [{"text":"<Mugcraft> ","color":"gold","bold":true},{"selector":"@s","color":"dark_red","bold":false},{"text":" was the first to get Full Netherite armor, everyone must take a drink, except ","color":"dark_red","bold":false},{"selector":"@s","color":"dark_red","bold":false},{"text":"!","color":"dark_red","bold":false}]
