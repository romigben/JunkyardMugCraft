...
tellraw @a [{"text":"<Mugcraft> ","color":"gold","bold":true},{"selector":"@s","color":"dark_purple","bold":false},{"text":" found the Stronghold, everyone must drink to celebrate!","color":"dark_purple","bold":false}]
