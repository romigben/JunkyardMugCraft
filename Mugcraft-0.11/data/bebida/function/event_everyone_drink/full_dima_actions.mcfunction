...
tellraw @a [{"text":"<Mugcraft> ","color":"gold","bold":true},{"selector":"@s","color":"aqua","bold":false},{"text":" was the first to get Full Diamond armor, everyone must take a sip of their drinks, except ","color":"aqua","bold":false},{"selector":"@s","color":"aqua","bold":false},{"text":"!","color":"aqua","bold":false}]
