...
tellraw @a [{"text":"<Mugcraft> ","color":"gold","bold":true},{"selector":"@s","color":"dark_red","bold":false},{"text":" was the first to kill a Ghast by deflecting its fireball and can now choose someone to take a shot!","color":"dark_red","bold":false}]
