...
tellraw @a [{"text":"<Mugcraft> ","color":"gold","bold":true},{"selector":"@s","color":"dark_red","bold":false},{"text":" found the first Ancient Debris and can now choose someone to take a shot!","color":"dark_red","bold":false}]
